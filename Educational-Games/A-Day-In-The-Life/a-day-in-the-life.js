...
function downbeat() {
  performanceOutcomes();
  img.setAttribute('src', '../A-Day-In-The-Life/jazz-club1.jpg');
  fadeIn(img, 1000);
}

function dunbar() {
  performanceOutcomes();
  img.setAttribute('src', '../A-Day-In-The-Life/live-music-sign.jpg');
  fadeIn(img, 1000);
}

function purcells() {
  performanceOutcomes();
  img.setAttribute('src', '../A-Day-In-The-Life/piano2.jpg');
  fadeIn(img, 1000);
}

function clubFlamingo() {
  performanceOutcomes();
  img.setAttribute('src', '../A-Day-In-The-Life/piano3.jpg');
  fadeIn(img, 1000);
}
...
function westCoast() {
  ...
  img.setAttribute('src', '../A-Day-In-The-Life/west-coast.jpg');
  fadeIn(img, 1000);
}
...
function midwest() {
  ...
  img.setAttribute('src', '../A-Day-In-The-Life/midwest.jpg');
  fadeIn(img, 1000);
}
...
function south() {
  ...
  img.setAttribute('src', '../A-Day-In-The-Life/south.jpg');
  fadeIn(img, 1000);
}
...
function eastCoast() {
  ...
  img.setAttribute('src', '../A-Day-In-The-Life/east-coast.jpg');
  fadeIn(img, 1000);
}
...
function goOnTour() {
  ...
  img.setAttribute('src', '../A-Day-In-The-Life/statue-of-liberty.jpg');
  fadeIn(img, 1000);
}
...
function getGigs() {
  ...
  img.setAttribute('src', '../A-Day-In-The-Life/nyc-cityscape.jpg');
  fadeIn(img, 1000);
}
...
function teaching() {
  ...
  img.setAttribute('src', '../A-Day-In-The-Life/piano.jpg');
  fadeIn(img, 1000);
}
...
function getEducated() {
  ...
  img.setAttribute('src', '../A-Day-In-The-Life/music-hall1.jpg');
  fadeIn(img, 1000);
}
...
function goHome() {
  ...
  earnings.innerHTML = `Total earnings: $ ${money}`;
  img.setAttribute('src', '../A-Day-In-The-Life/new-york-cityscape.jpg');
  fadeIn(img, 1000);
