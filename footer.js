document.getElementById("footer").innerHTML = `
    <footer class="footer-container">
        <div class="footer-styles">
            ...
            <a class="footer-links" href="https://www.youtube.com/watch?v=FIWELCEBG0E&list=PLqHdMZJ08WM11cAx7YqdmvHb5YawvM0sq" target="_blank">Black Excellence Series</a>
        </div>
        
        <div class="footer-styles">
            <a class="footer-links" href="/Resources/Educational-Games/A-Day-In-The-Life/a-day-in-the-life.html">A day in the Life Game</a>
            <a class="footer-links" href="/Resources/Educational-Games/Memory-Game/Memory-game.html">Memory Game</a>
        </div>
        <div class="footer-styles">
